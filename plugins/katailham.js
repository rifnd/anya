...
let handler = async (m, { conn, usedPrefix }) => {
  ...
  conn.sendButton(m.chat, `*${pickRandom(ilham)}*\n_-Kata ilham_`, wm, 'Next', '.ilham', m)
}
handler.help = ['katailham']
handler.tags = ['quotes']
handler.command = /^(ilham|katailham)$/i
handler.owner = false
handler.mods = false
...
"Omonganmu empuk koyok telo, tapi nyereti",
"Aku tanpamu, seneng lah",
...
"Gausah semangat, males aja",
"Ngapain berjuang kalo ujung ujungnya, gatau saya",
